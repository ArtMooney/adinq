...
<template>
  ...
  >
    ...
    <div
      class="absolute inset-0 z-[-1] bg-gradient-to-r from-blue-500 to-green-500 opacity-0 blur-xl transition-all duration-300 ease-in-out group-hover:opacity-75"
      :class="[
        currentPath === route &&
