...
<template>
  <div class="flex flex-col">
    ...
    <!--      class="fixed top-0 right-0 bottom-0 left-0 z-50 flex items-center justify-center bg-black/75"-->
    <!--    >-->
    ...
    <!--      </div>-->
    <!--      <div-->
    <!--        class="absolute top-0 right-auto bottom-0 left-0 flex items-center justify-center p-4"-->
    <!--      >-->
    <!--        <div-->
    ...
    <!--      </div>-->
    <!--      <div-->
    <!--        class="absolute top-0 right-0 bottom-0 left-auto flex items-center justify-center p-4"-->
    <!--      >-->
    <!--        <div-->
    <!--          class="flex h-12 w-12 cursor-pointer items-center rounded-full border-2 border-solid border-white p-4 hover:opacity-75"-->
    <!--          @click="rightArrow"-->
    ...
    <!--        </div>-->
    <!--      </div>-->
    <!--      <div class="absolute top-4 right-4 bottom-auto left-auto cursor-pointer">-->
